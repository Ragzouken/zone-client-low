 ...
 */
 export function createRendering2D(width, height) {
 ...
 */
export function fillRendering2D(rendering, fillStyle = undefined) {
 ...
 */
export function copyRendering2D(
    source, 
 ...
 * @param {number} height 
 */
export function resizeRendering2D(rendering, width, height) {
 ...
 * @param {CanvasRenderingContext2D} rendering 
 */
export function invertMask(rendering) {
 ...
 * @param {number} dy
 */
export function cycleRendering2D(rendering, dx, dy) {
 ...
 * @param {CanvasRenderingContext2D} rendering 
 */
export function mirrorRendering2D(rendering) {
 ...
 * @param {CanvasRenderingContext2D} rendering 
 */
 export function flipRendering2D(rendering) {
    const prevComposite = rendering.globalCompositeOperation;
    rendering.globalCompositeOperation = "copy";
    rendering.scale(1, -1);
 ...
 * @param {number} turns
 */
 export function turnRendering2D(rendering, turns=1) {
    const { width, height } = rendering.canvas;
    const prevComposite = rendering.globalCompositeOperation;
 ...
 */
export function withPixels(rendering, action) {
 ...
 * @param {CanvasRenderingContext2D} destination 
 */
export function recolorMask(mask, style, destination = undefined) {
...
export function lineplot(x0, y0, x1, y1, plot) {
    x0 |= 0; y0 |= 0; x1 |= 0; y1 |= 0;
 ...
 * @param {number} color
 */
export function floodfill(rendering, x, y, color, tolerance = 5) {
 ...
 * @returns {CanvasRenderingContext2D}
 */
 export function floodfillOutput(rendering, x, y, color) {
    const [width, height] = [rendering.canvas.width, rendering.canvas.height];
 ...
 * @param {number} alpha
 */
export function hexToUint32(hex, alpha = undefined) {
 ...
 * @param {string} prefix 
 */
export function numberToHex(number, prefix = '#') {
 ...
 * @returns {CanvasRenderingContext2D}
 */
export function textToRendering2D(text, palette = MASK_PALETTE) {
    text = text.trim();
...
export function uint32ToRGB(uint32) {
    return {
        r: uint32 >>>  0 & 0xFF,
        g: uint32 >>>  8 & 0xFF,
        b: uint32 >>> 16 & 0xFF,
...
export function RGBToUint32(rgb) {
 ...
 */
export function recolorToPalette(rendering, palette) {
 ...
 * @param {string[]} next 
 */
 export function swapPalette(rendering, prev, next) {
    const mapping = new Map();
 ...
 * @param {number[]} next 
 */
export function swapPaletteSafe(rendering, prev, next) {
    const mapping = new Map();
